    ...
    public partial class inital : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    firstTimeSlot = table.Column<bool>(type: "bit", nullable: false),
                    secondTimeSlot = table.Column<bool>(type: "bit", nullable: false),
                    thirdTimeSlot = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    bookedAppointment = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    doctorId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MedicalHistories_Doctors_doctorId1",
                        column: x => x.doctorId1,
                        principalTable: "Doctors",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicalHistories_doctorId1",
